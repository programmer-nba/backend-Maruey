...
const DealerSchema = new mongoose.Schema(
  {
    ...
    dealer_status:{type:Boolean,default:false},  //(true: อนุมัติ ,false: ไม่อนุมัติ)
    dealer_status_promiss: {type:Boolean,default:false},  //( true:ยอมรับเงื่อนไข , false: ยังไม่ยอมรับเงื่อนไข)  // สัญญา partner
...
module.exports = {Dealer,validatedealer};